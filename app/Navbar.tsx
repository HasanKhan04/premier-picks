...
const Navbar = () => {
    ...
    const handleSubmit = () => {
        router.push(`/stats?name=${searched}`);         
    }
        ...
        <div className="navbar" style={{ backgroundColor: '#2D0C3D' }}>
            ...
            <div className="navbar-end" style={{ width: '30%' }}>
                <div className="form-control">
                    <input onKeyPress={handleKey} onChange={handleChange} type="text" placeholder="Search Players" className="input input-bordered w-24 md:w-auto mr-6" />
                </div>
            </div>
        </div>
    )
